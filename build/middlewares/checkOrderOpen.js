...
var verifyAuthToken = function (_req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, sql, conn, result, order, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                err_1 = _a.sent();
                res.status(404).json('Order not valid' + err_1);
                return [3 /*break*/, 5];
