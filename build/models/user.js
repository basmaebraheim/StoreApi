...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Error in get all user: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Error in find user ".concat(id, ": ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    // create user
    UserStore.prototype.create = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1.default.hashSync(request.password + process.env.BCRYPT_PASSWORD, Number(process.env.SALT_ROUNDS));
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Error in create new user: ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Error in delete user: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
